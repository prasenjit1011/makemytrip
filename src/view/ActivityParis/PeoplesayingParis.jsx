...
function PeoplesayingParis({cityDetail}) {
    return (
        <>
            <section className="whatPepSec">
                <div className="container-fluid">
                    <div className="row">
                        <div className="whatPepCol col">
                            <p className="whText">
                                What <span>people</span> are saying about <span>{cityDetail?.cityName}</span>
                            </p>
                        </div>
                    </div>
                    <div className="row">
                        <div className="whatPepCol2 col">
...
export default PeoplesayingParis